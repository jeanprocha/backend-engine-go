...
- evidence_highlights (opcional mas recomendado): array de até 8 objetos {"evidence_index":N,"snippets":[...],"snippets_tentative":[...]} onde N é o número do bloco [N] no CONTEXTO JURÍDICO. Cada string em snippets e snippets_tentative deve ser copiada LITERALMENTE do texto desse bloco (substrings que existem no trecho), preferindo frases muito curtas, termos técnicos ou expressões mínimas que fundamentem a decisão. ALVO DE COMPRIMENTO: idealmente entre 100 e 180 caracteres por string (cláusula ou conectivo; termos técnicos mais curtos são aceitáveis). Nunca exceda ~180 caracteres: o servidor trunca. É PROIBIDO colar o parágrafo inteiro, o inciso completo, listas longas ou blocos de várias frases: recorte só o excerto que prova o nexo. snippets = âncoras fortes; snippets_tentative = nexo mais fraco. Máximo 5 strings por lista por objeto. Não use termos genéricos de uma palavra nem duplicados redundantes.
